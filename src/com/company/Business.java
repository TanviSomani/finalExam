...
public class Business extends LoanP implements Generate{   private double monthly_payment = 0.0;
    ...
    public Business(int cno, String cname, double loan_amt, int yrs, String ltype) {
